...
public class SignCommand implements Callable<Integer> {
    ...
    public Integer call() {
        try {
            ...
            io.github.cyberstamp.sigmund.core.Sigmund sigmund = io.github.cyberstamp.sigmund.core.Sigmund.builder()
                    .addTool(gpg)
                    .addTool(sq)
                    .build();
            io.github.cyberstamp.sigmund.core.SigningOutput result = sigmund.signer()
