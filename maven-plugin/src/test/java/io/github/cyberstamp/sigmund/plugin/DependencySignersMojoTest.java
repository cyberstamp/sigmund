...
import io.github.cyberstamp.sigmund.plugin.SignatureInspector.SignedArtifact;
...
class DependencySignersMojoTest {
    ...
    class SignedArtifactEdgeCases {
        ...
        void unverifiedWithFail() {
            ...
            assertInstanceOf(io.github.cyberstamp.sigmund.core.UnverifiedResult.class, sa.verifyResult());
        }
    }
